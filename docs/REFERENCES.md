...
| [jev-drone](https://github.com/RomanSlack/jev-drone) | 决策与控制分离 | 模型选择与 MuJoCo 控制循环分开 |
| [jevduck](https://github.com/amazedsaint/jevduck) | 可检查、可控制的实验 | 暂停、停止、结果反馈与日志 |
| [openarm-jev-lab](https://github.com/tripathiarpan20/openarm-jev-lab) | 仿真与界面分离 | 后台实验与浏览器工作台 |
...
进一步阅读：[⚡ 快速推理与源码分析](FAST_INFERENCE.md) · [🆚 模型对比](COMPARISON.md) · [📊 实测结果](VALIDATION.md) · [📄 第三方许可](../THIRD_PARTY_NOTICES.md)
